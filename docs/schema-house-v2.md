...
- **Paste** inserts as a **sibling** of the selection (under the common parent
  of selected places/elements). With nothing selected, pastes into the current
  canvas location. Colliding sibling ids rename
