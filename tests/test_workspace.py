...
class TestWorkspaceUnit(unittest.TestCase):
    def test_open_close_save_as_unit(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(es.yaml_path.name, "Nuevo_sitio.yaml")
            self.assertEqual(es.title, "Nuevo_sitio.yaml")
...
class TestWorkspaceApi(unittest.TestCase):
    def test_open_close_save_as(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(new_body["document"]["yaml"], "Nuevo_sitio.yaml")
            self.assertEqual(new_body["document"]["title"], "Nuevo_sitio.yaml")
