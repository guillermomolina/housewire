...
(function (global) {
  ...
  const MESSAGES = {
    en: {
      ...
      "palette.needsElectrical": "Enable the electrical layer (View → Electrical) to insert elements",
      "insert.type": "Type",
    ...
    es: {
      ...
      "palette.needsElectrical": "Activa la capa eléctrica (Ver → Eléctrico) para insertar elementos",
      "insert.type": "Tipo",
