...
(function (global) {
  ...
  const MESSAGES = {
    en: {
      ...
      "props.key.orientationNorthSouth": "Orientation North/South",
      "props.key.orientationWestEast": "Orientation West/East",
    ...
    es: {
      ...
      "props.key.orientationNorthSouth": "Orientación Norte/Sur",
      "props.key.orientationWestEast": "Orientación Oeste/Este",
