...
(function (global) {
  ...
  const MESSAGES = {
    en: {
      ...
      "props.key.orientationNorthSouth": "Vertical orientation",
      "props.key.orientationWestEast": "Horizontal orientation",
    ...
    es: {
      ...
      "props.key.orientationNorthSouth": "Orientación vertical",
      "props.key.orientationWestEast": "Orientación horizontal",
