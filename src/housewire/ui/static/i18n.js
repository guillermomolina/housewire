...
(function (global) {
  ...
  const MESSAGES = {
    en: {
      ...
      "status.conduitCreated": "conduit created · unsaved",
      "status.conductorCreated": "conductor created · unsaved",
      "status.linkSaved": "link updated",
      "status.linkSavedUnsaved": "link updated · unsaved",
      "status.linkDeleted": "link deleted · unsaved",
      "status.linkClaimed": "open run claimed · unsaved",
      "status.linkLanded": "open run landed · unsaved",
      "status.linkGrouped": "cable sheath created · unsaved",
    ...
    es: {
      ...
      "status.conduitCreated": "tubo creado · sin guardar",
      "status.conductorCreated": "conductor creado · sin guardar",
      "status.linkSaved": "enlace actualizado",
      "status.linkSavedUnsaved": "enlace actualizado · sin guardar",
      "status.linkDeleted": "enlace eliminado · sin guardar",
      "status.linkClaimed": "tramo reclamado · sin guardar",
      "status.linkLanded": "tramo aterrizado · sin guardar",
      "status.linkGrouped": "funda de cable creada · sin guardar",
