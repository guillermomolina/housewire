...
(function (global) {
  ...
  const MESSAGES = {
    en: {
      ...
      "insert.placeHint": "Click and drag on canvas to place and size the new item.",
    ...
    es: {
      ...
      "insert.placeHint": "Haz clic y arrastra en el lienzo para ubicar y dimensionar el nuevo elemento.",
