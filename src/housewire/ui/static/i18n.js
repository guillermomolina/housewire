...
(function (global) {
  ...
  const MESSAGES = {
    en: {
      ...
      "props.face.summaryEmpty": "No faces configured — expand a face to set capacity",
    ...
    es: {
      ...
      "props.face.summaryEmpty": "Sin caras configuradas — despliega una cara para fijar capacidad",
      "props.face.usedOf": "{used}/{total}",
